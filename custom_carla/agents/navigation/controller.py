...
import carla
from custom_carla.agents.tools.misc import get_speed
...
class VehiclePIDController():
    ...
    def run_step(self, target_speed, location: carla.Location):
        """
        ...
        steering = self._lat_controller.run_step(location)
...
class PIDLateralController():
    ...
    def run_step(self, location: carla.Location):
        """
    ...
    def _pid_control(self, location: carla.Location, vehicle_transform):
        """
        ...
        w_vec = np.array([location.x -
                          v_begin.x, location.y -
                          v_begin.y, 0.0])
