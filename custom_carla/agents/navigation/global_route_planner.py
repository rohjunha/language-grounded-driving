...
from custom_carla.agents.tools.misc import vector
...
class GlobalRoutePlanner(object):
    ...
    def _localize(self, location):
        ...
        location        :   custom_carla.Location to be localized in the graph
    ...
    def _path_search(self, origin, destination):
        ...
        origin      :   custom_carla.Location object of start position
        destination :   custom_carla.Location object of of end position
    ...
    def abstract_route_plan(self, origin, destination):
        ...
        origin      : custom_carla.Location object of the route's start position
        destination : custom_carla.Location object of the route's end position
    ...
    def trace_route(self, origin, destination):
        """
        This method returns list of (custom_carla.Waypoint, RoadOption)
        from origin (custom_carla.Location) to destination (custom_carla.Location)
        """
